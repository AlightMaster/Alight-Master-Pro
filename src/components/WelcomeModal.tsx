...
export const WelcomeModal: React.FC<WelcomeModalProps> = ({ isOpen, onClose }) => {
  ...
  useEffect(() => {
    const handleSettingsUpdate = () => {
      setWaGroupLink(localStorage.getItem('alight_link_wa_group') || 'https://chat.whatsapp.com');
      setWaChannelLink(localStorage.getItem('alight_link_wa_channel') || 'https://whatsapp.com/channel');
      setTgGroupLink(localStorage.getItem('alight_link_tg_group') || 'https://t.me');
      setAdminDirectLink(localStorage.getItem('alight_link_admin_direct') || 'https://wa.me');
      setSocialTgLink(localStorage.getItem('alight_link_social_tg') || 'https://t.me');
      setSocialTiktokLink(localStorage.getItem('alight_link_social_tiktok') || 'https://tiktok.com');
      setSocialIgLink(localStorage.getItem('alight_link_social_ig') || 'https://instagram.com');
      setSocialGithubLink(localStorage.getItem('alight_link_social_github') || 'https://github.com');
    };
